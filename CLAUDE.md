...
- `EMBEDDING_PROVIDER` - Embedding provider selection: `openai` or `voyage` (default: openai)
- `VOYAGE_API_KEY` - Voyage AI API key (alternative embedding provider)
- `VOYAGE_EMBEDDING_MODEL` - Voyage embedding model (default: voyage-3)
